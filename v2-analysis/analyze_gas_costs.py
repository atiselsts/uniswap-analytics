...
V2_SWAP_COST_ETH = V2_SWAP_GAS * GAS_PRICE_GWEI / 1e9
V3_SWAP_COST_ETH = V3_SWAP_GAS * GAS_PRICE_GWEI / 1e9

POOLS = [
    (2, "0xb4e16d0168e52d35cacd2c6185b44281ec28c9dc", "v2 USDC/ETH", V2_SWAP_COST_ETH),
    (3, "0x8ad599c3a0ff1de082011efddc58f1908eb6e6d8", "v3 USDC/ETH 0.3%", V3_SWAP_COST_ETH),
    (3, "0x88e6a0c2ddd26feeb64f039a2c41296fcb3f5640", "v3 USDC/ETH 0.05%", V3_SWAP_COST_ETH),
]
...
def main():
    ...
    for (version, pool, name, swap_cost_eth) in POOLS:
        ...
        print("swap_cost_eth=", swap_cost_eth)
        print("pool_reserves_in_eth=", pool_reserves_in_eth)

        swap_costs_bps = [swap_cost_eth / u * 10_000 for u in pool_reserves_in_eth]
        print("costs=", swap_cost_eth)

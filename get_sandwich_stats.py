...
decimals = 18 # for USDC

self_dir = os.path.dirname(os.path.abspath(__file__))
data_dir = os.path.join(os.path.dirname(os.path.dirname(self_dir)), "data", "uniswap-v3-swaps", YEAR)
...
def classify_trades(trades, data):
    ...
    # amount0: USDC, amount1: ETH
    for _, block, _, amount0, amount1, address, _ in data:
...
def main():
    ...
    print("top sandwch traders by num tx:")
